...
const Main = () => {
    ...
    return (
        <div className='main'>
            <div className="nav">
                <p className="logo-text">Joy<span>AI</span></p>
            ...
            <div className="main-container">
                {!showResult ? (
                    <>
                        <div className="greet">
                            <p><span>Design. Create. Automate.</span></p>
                            <p>How can I assist your workflow today?</p>
                        </div>
                        <div className="cards">
                            <div className="card" onClick={() => handleCardClick("Suggest beautiful places to see on an upcoming road trip")}>
                                <p>Suggest beautiful places to see on an upcoming road trip</p>
                                <div className="icon-wrapper"><img src={assets.compass_icon} alt="" /></div>
                            </div>
                            <div className="card" onClick={() => handleCardClick("Briefly summarize this concept: urban planning")}>
                                <p>Briefly summarize this concept: urban planning</p>
                                <div className="icon-wrapper"><img src={assets.bulb_icon} alt="" /></div>
                            </div>
                            <div className="card" onClick={() => handleCardClick("Brainstorm team bonding activities for our work retreat")}>
                                <p>Brainstorm team bonding activities for our work retreat</p>
                                <div className="icon-wrapper"><img src={assets.message_icon} alt="" /></div>
                            </div>
                            <div className="card" onClick={() => handleCardClick("Improve the readability of the following code")}>
                                <p>Improve the readability of the following code</p>
                                <div className="icon-wrapper"><img src={assets.code_icon} alt="" /></div>
                            </div>
                        </div>
                    </>
                ) : (
